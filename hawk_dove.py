...
Uvažujme jednotlivce jednoho druhu se dvěma vzorci chování. Chování se projeví v tom, zda jedinec bojuje o přístup ke zdrojům pro přežití a reprodukci, či nikoliv. Zdroji může být například prostor k hnízdění nebo přístup k potravě. Nebojovné chování budeme nazývat holubičí povahou a jejich nositele budeme označovat jako holubice. Holubičí povahy se vyhýbají konfliktu a místo boje raději hledají jiné zdroje. Kromě mírumilovných holubic budou v populaci i takzvaní jestřábi, což jsou jedinci s bojovnou povahou. Pokud se však u zdroje sejdou dva jestřábi, potom o tento zdroj bojují. Boj vyžaduje nějaké úsilí a to oslabí reprodukční zdatnost jedinců, kteří bojovali. Na druhou stranu, po vyhraném boji má jestřáb přístup ke zdroji, o který se bojovalo. Sejde-li se u jednoho zdroje jestřáb a holubice, holubice ustoupí a zdroj připadne jestřábovi. 

Je možné ukázat, že rozumné předpoklady o vývoji populace a charakteru bojů vedou k tomu, že procentuální zastoupení jestřábího chování v populaci se dá modelovat diferenciální rovnicí, která je na obrazovce. V této rovnici figuruje procentuální zastoupení jestřábů x, náklady na boj mezi dvěma jestřáby vyjádřený parametrem D a zisk z konzumace zdroje označený parametrem V.

Rovnice má tři stacionární body, nula, jedna a V/D. Je-li V/D mezi nulou a jedničkou, může být situace jako na obrázku. Rovnice má nestabilní stacionární body x=0 a x=1, protože funkce z pravé strany rovnice zde protíná vodorovnou osu jako rostoucí funkce. 
Kromě toho má rovnice mezi nulou a jedničkou stacionární bod x=V/D a ten je stabilní, protože funkce definující pravou stranu protíná v tomto bodě vodorovnou osu jako klesající funkce. Na procentu V/D se proto usadí procentuální zastoupení jestřábů.

Podívejme se, co to znamená pro naši populaci. Uvedený případ nastává, pokud jsou náklady na boj větší než velikost zdroje. Nestabilita stacionárního bodu x=1 souvisí s malým ziskem z vítězného boje. Vzhledem k malé výhře ve srovnání s náklady na boj se může vyplatit chovat se jako holubice a vyhýbat se boji, protože ten nese malý užitek. Bod x=0 je však také nestabilní. Samé holubice proto v populaci být také nemohou. A opravdu, je to pochopitelné. Pokud totiž do populace holubičích povah pronikne jedna jestřábí povaha, má tento jestřáb k dispozici veškeré zdroje, protože mu všichni ustupují. To znamená, že se jeho geny a jeho vzorec chování bode šířit rychleji než vzorec holubičího chování a nezanikne. 

Zkusme teď snižovat náklady na boj. Podíl V/D tedy bude růst. Vidíme, že stacionární bod se posunuje k větší frekvenci jestřábů. To je pochopitelné, čím lákavější je zisk z boje ve srovnání s náklady na boj, tím větší procento populace tomuto lákání podlehne a bude o zdroje bojovat.

Pro V=D dojde ke splynutí dvou stacionárních bodů a nadále populace bude složena jenom z jestřábů. Ani další snižování nákladů na boj situaci nemění. Jenom bude systém rychleji konvergovat do stacionárního bodu. 

Model ukazuje, že jsou-li náklady na boj malé ve srovnání se ziskem při konzumaci zdroje, budou v populaci jenom samí jestřábi. To je případ například stromů v lese. Zdroj je sluneční svit a náklady na boj spočívají ve vybudování delšího kmene. Náklady na boj jsou relativně malé a proto jsou všechny stromy v lese vysoké. 
...
A to je i špatná zpráva pro všechny mírumilovné povahy. Jenomže, když se nad tím zamyslíme, chodí to tak nějak i v lidské společnosti. Ať už na úrovni malých kolektivů, nebo na úrovni celých národů. Zkuste si sami rozmyslet, jestli znáte nějaký vhodný příklad. 
"""